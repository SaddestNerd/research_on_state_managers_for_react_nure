...
import { loginThunk } from '../app/services/slices/auth/thunks'
...
const LoginPage = () => {
  ...
  const { loading, error, success, userData } = useSelector((state) => state.auth)
  ...
  const onFinish = async (values) => {
    try {
      ...
      message.error(error || 'Помилка входу')
    }
  }
