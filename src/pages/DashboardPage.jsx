...
import { useContextTests } from '../app/performance/useContextTests'
...
const DashboardPage = () => {
  ...
  const { items, totalItems, totalPrice, addToCart, removeFromCart, updateQuantity, clearCart } = cartContext
  const [cartVisible, setCartVisible] = useState(false)

  useContextTests(cartContext, { products, getProducts }, { userData })
