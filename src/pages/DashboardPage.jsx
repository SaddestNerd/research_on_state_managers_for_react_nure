...
import { getProductsThunk } from '../app/services/slices/products/thunks'
import { addToCart, removeFromCart, updateQuantity, clearCart } from '../app/services/slices/cart/slice'
...
const DashboardPage = () => {
  ...
  useEffect(() => {
    dispatch(getProductsThunk({ offset: 0, limit: 10 }))
  }, [dispatch])

  const handlePageChange = (page, pageSize) => {
    const offset = (page - 1) * pageSize
    dispatch(getProductsThunk({ offset, limit: pageSize }))
  }
