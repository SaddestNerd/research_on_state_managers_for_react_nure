...
import { Card, Typography, Space, Avatar, Row, Col, Spin, Pagination, Image, Tag, Empty, Button, Drawer, InputNumber, message, Badge } from 'antd'
import { UserOutlined, ShoppingOutlined, ShoppingCartOutlined, PlusOutlined, MinusOutlined, DeleteOutlined } from '@ant-design/icons'
import { useRenderTracker } from '../app/performance/useRenderTracker'

const { Title, Text, Paragraph } = Typography

const DashboardPage = observer(({ authStore, productsStore, cartStore }) => {
  useRenderTracker('DashboardPage')
  
  const { userData } = authStore
  const { products, loading, error, pagination, getProducts } = productsStore
  const { items, totalItems, totalPrice, addToCart, removeFromCart, updateQuantity, clearCart, getItemQuantity } = cartStore
                      ...
                      {cartQuantity > 0 ? (
                        <div style={{
                          ...
                          <Button
                            ...
                            size="small"
                          />
                          <Text strong style={{ minWidth: '40px', textAlign: 'center' }}>
                            {cartQuantity}
                          </Text>
                          <Button
                            icon={<PlusOutlined />}
...
export default inject('authStore', 'productsStore', 'cartStore')(DashboardPage)
